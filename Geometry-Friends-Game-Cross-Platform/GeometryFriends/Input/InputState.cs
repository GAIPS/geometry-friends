...
namespace GeometryFriends.Input
{
    ...
    internal class InputState
    {
        ...
        public ControllerHandler controllerInput;
        ...
        {            
            ...
            controllerInput = new ControllerHandler();
            ...
            get
            {
                return IsNewKeyPress(Keys.Up) ||
                       ...
                       (CurrentGamePadState.ThumbSticks.Left.Y > 0 &&
                        ...
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.BUTTON_UP) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.BUTTON_UP) ||
        ...
        public bool MenuDown
        {
            get
            {
                return IsNewKeyPress(Keys.Down) ||
                       ...
                       (CurrentGamePadState.ThumbSticks.Left.Y < 0 &&
                        LastGamePadState.ThumbSticks.Left.Y >= 0) ||*/
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.BUTTON_DOWN) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.BUTTON_DOWN) ||
        ...
        public bool MenuLeft
        {
            get
            {
                return IsNewKeyPress(Keys.Left) ||
                       ...
                       controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.BUTTON_LEFT) ||
                       controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.BUTTON_LEFT) ||
        ...
        public bool MenuRight
        {
            get
            {
                return IsNewKeyPress(Keys.Right) ||
                        ...
                        (CurrentGamePadState.ThumbSticks.Left.X > 0 &&
                         LastGamePadState.ThumbSticks.Left.X <= 0) ||*/
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.BUTTON_RIGHT) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.BUTTON_RIGHT) ||
            ...
            get
            {
                return IsNewKeyPress(Keys.Space) ||
                       IsNewKeyPress(Keys.Enter) ||
                        ...
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.BUTTON_X) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.START) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.BUTTON_X) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.START) ||
        ...
        public bool MenuCancel
        {
            get
            {
                return IsNewKeyPress(Keys.Escape) ||
                        ...
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_1, ControllerKeys.BACK) ||
                        controllerInput.IsKeyPressed(ControllerIndex.CONTROLLER_2, ControllerKeys.BACK) ||
